...
class ParentalControl(xbmcgui.WindowXMLDialog):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.levels_count = len(self.rating_levels) - 1
    ...
    def onInit(self):
        ...
        slider_control.setInt(self.current_level_index, 0, 1, self.levels_count)
    ...
    def _update_status_desc(self, new_level_index=None):
        ...
        for index in range(0, self.levels_count + 1):
    ...
    def _generate_levels_labels(self):
        ...
        width = int(1200 / (self.levels_count + 1))
        height = 100
        pos_x = 175
        pos_y = 508  # 668
        self.controls = {}
